...
— see =docs/adr/0001-scheduled-deployment-windows.org= and =scenarios.org=.
...
stateDiagram-v2
    ...
    Verified --> Live: production deploy
...
sequenceDiagram
    ...
    IDP->>Prod: deploy the same digests
...
=docs/adr/0001-scheduled-deployment-windows.org= is where the options that
remove it live.
