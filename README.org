...
| 2 Held | =staging:hold=, one person-owned pause at one scope | let a person look before promotion, without a second stop mechanism competing with it |
| 3 Scheduled | =release:scheduled=, a calendar, windows | book a slot, defer a start to it, reap one that lapsed unattempted |
